...
//2. try ( 객체 생성 구문) {} catch {} : 자동으로 close() 됨 /// try (with resource)
...
class A implements AutoCloseable{ //5. # 필드, 생성자, 오버라이딩 순으로 일정한 규칙을 두면 좋음.
	...
	@Override
	public void close() throws Exception { //7. close 메서드가 자동으로 호출됨.
