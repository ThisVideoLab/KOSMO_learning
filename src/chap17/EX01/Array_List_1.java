 ...
 * 		방의 크기는 수정 불가. 만약 굳이 늘리고 싶다면 꽉찼을 경우에 그것을 조건문에 반영해서 새로운 더 큰 크기의
 *      배열을 생성하고, 이전의 꽉 찬 배열에 담긴 값을 새로 생성된 배열에 넣는 번거로운 방식을 취해야 함.
 * 		일전에 예제를 풀면서 그러한 코드를 짠 적이 있으니 EX 패키지를 참고해볼 것.
 * 
